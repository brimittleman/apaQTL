...
ggplot(allPAS_loc, aes(x=loc, y=prop, fill=SS)) + geom_bar(stat="identity") + scale_fill_brewer(palette="Paired") +labs(title="Proportion of PAS with signal site", x="Location", y="Propotion")  + labs(fill = "Presence of Signal Site",x="") +scale_x_discrete(labels = c('Coding','5kb downstream','Intronic',"3' UTR", "5' UTR")) +theme(axis.text.x = element_text(angle = 90, hjust = 1))
```

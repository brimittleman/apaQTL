...
ggplot(fullDF_melt,aes(x=Cutoff, y=propGene, by=Category, fill=Category)) + geom_bar( stat="identity") + scale_fill_brewer(palette="GnBu") + labs(title="Proportion of genes with Multiple PAS by Total Usage filter",y="Proportion of 27115 genes", x="Usage Filter cutoff")
```
Nuclear:  
```{r}
...
totplotloc=ggplot(FullDF_loc_melt,aes(x=Cutoff, y=propPAS, by=Location, fill=Location)) + geom_bar( stat="identity") + scale_fill_brewer(palette="GnBu") + labs(title="PAS location: Total Fraction",y="Proportion of PAS", x="Usage Filter cutoff")
```
...
nucplotloc=ggplot(NucFullDF_locMelt,aes(x=Cutoff, y=propPAS, by=Location, fill=Location)) + geom_bar( stat="identity") + scale_fill_brewer(palette="GnBu") + labs(title="PAS location: Nuclear Fraction",y="Proportion of PAS", x="Usage Filter cutoff")
```

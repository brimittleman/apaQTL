...
```{r}
AllQTLs=as.data.frame(rbind(NuclearResM,explainedResM,unexplainedResM)) 

AllQTLsProp=as.data.frame(rbind(NuclearResMProp,explainedResMProp,unexplainedResMProp)) 
```

...
meta_TBatch_order = meta_TBatch_order %>% mutate(color=ifelse(batch=="1", "blue", ifelse(batch=="2", "green", ifelse(batch=="3", "purple", "pink"))))
...
meta_NBatch_order = meta_NBatch_order %>% mutate(color=ifelse(batch=="1", "blue", ifelse(batch=="2", "green", ifelse(batch=="3", "purple", "pink"))))

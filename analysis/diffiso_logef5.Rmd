---
title: "Diff iso with effect size greater than .5"
...
```{r}
effectsize=read.table("../data/DiffIso/TN_diff_isoform_AllChrom_effect_sizes.txt", stringsAsFactors = F, col.names=c('intron',  'logef' ,'Nuclear', 'Total','deltaPAU')) %>% filter(intron != "intron") %>% filter(logef>.5)
```

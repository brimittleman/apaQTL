...
* [Location of QTLs with respect to PAS and gene body](QTLlocation.hml)
...
* [Nuclear specific apaQTLs are more likely to be eQTLs](NuclearSpecAPAqtl.html)

* [Comparing protein specific genes with apaQTL](pQTLandeQTLoverlap.Rmd)

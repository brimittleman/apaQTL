...
```{r}
totalold=ggplot(totalPeakoldM,aes(x=No,y=Yes)) + geom_point() + geom_density2d() + labs(x="39 ind", y="15 ind", title="Total Usage Old data")
totalnew=ggplot(totalPeaknewM,aes(x=No,y=Yes)) + geom_point() + geom_density2d() + labs(x="39 ind", y="15 ind", title="Total Usage New data")
```
...
```{r}
nuclearold=ggplot(nuclearPeakoldM,aes(x=No,y=Yes)) + geom_point() + geom_density2d() + labs(x="39 ind", y="15 ind", title="Nuclear Usage Old data")
nuclearnew=ggplot(nuclearPeaknewM,aes(x=No,y=Yes)) + geom_point() + geom_density2d() + labs(x="39 ind", y="15 ind", title="Nuclear Usage New data")
```
...
```{r}
totaloldnewpeak=ggplot(totalPeakoldM_new,aes(x=No,y=Yes)) + geom_point() + geom_density2d() + labs(x="39 ind", y="15 ind", title="Total Usage Old data \n New Peaks ")
totalnewnewpeak=ggplot(totalPeaknewM_new,aes(x=No,y=Yes)) + geom_point() + geom_density2d() + labs(x="39 ind", y="15 ind", title="Total Usage New data\n New Peaks ")
...
```{r}
nuclearoldnewpeak=ggplot(nuclearPeakoldM_new,aes(x=No,y=Yes)) + geom_point() + geom_density2d() + labs(x="39 ind", y="15 ind", title="nuclear Usage Old data \n New Peaks ")
nuclearnewnewpeak=ggplot(nuclearPeaknewM_new,aes(x=No,y=Yes)) + geom_point() + geom_density2d() + labs(x="39 ind", y="15 ind", title="nuclear Usage New data\n New Peaks ")

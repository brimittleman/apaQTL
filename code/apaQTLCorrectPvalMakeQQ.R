...
#plot qqplot
png("../output/qqplot_Total_APAperm.png")
...
write.table(tot.perm, file = "../data/apaQTLPermuted/APApeak_Phenotype_GeneLocAnno.Total_permResBH.txt", col.names = T, row.names = F, quote = F)
...
#plot qqplot
png("../output/qqplot_Nuclear_APAperm.png")
...
# write df with BH
write.table(nuc.perm, file = "../data/apaQTLPermuted/APApeak_Phenotype_GeneLocAnno.Nuclear_permResBH.txt", col.names = T, row.names = F, quote = F)

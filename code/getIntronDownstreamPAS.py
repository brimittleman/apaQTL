infile="../data/intronRNAratio/TotalIntronicPAS2Intron.txt"
outfileSAF="../data/intronRNAratio/TotalIntronicPAS_intronDownstream.SAF"
outfilebed="../data/intronRNAratio/TotalIntronicPAS_intronDownstream.bed"
